...
exports.initiateOrGetConversation = initiateOrGetConversation;
exports.getTouristConversations = getTouristConversations;
exports.getConversationThread = getConversationThread;
exports.sendMessageInConversation = sendMessageInConversation;
...
async function initiateOrGetConversation(req, res, next) {
    try {
        if (!req.user)
        ...
        if (!vendor)
            throw new apiError_js_1.ApiError(404, 'Vendor not found');
...
async function getTouristConversations(req, res, next) {
    try {
        if (!req.user)
            throw new apiError_js_1.ApiError(401, 'Unauthorized');
...
async function getConversationThread(req, res, next) {
    try {
        ...
        if (!conversation)
            throw new apiError_js_1.ApiError(404, 'Conversation not found');
        ...
        if (!isTourist && !isVendorOwner) {
            throw new apiError_js_1.ApiError(403, 'Forbidden: You do not have permission to view this conversation');
        }
...
async function sendMessageInConversation(req, res, next) {
    try {
        if (!req.user)
            throw new apiError_js_1.ApiError(401, 'Unauthorized');
        const { id } = req.params;
        ...
        const isVendorOwner = conversation.vendor.userId === req.user.userId;
        if (!isTourist && !isVendorOwner) {
            throw new apiError_js_1.ApiError(403, 'Forbidden: You do not have permission to reply in this conversation');
        }
