...
exports.generateBiharTravelRecommendation = generateBiharTravelRecommendation;
const generative_ai_1 = require("@google/generative-ai");
const env_js_1 = require("../config/env.js");
let genAI = null;
if (env_js_1.env.GEMINI_API_KEY) {
    try {
        genAI = new generative_ai_1.GoogleGenerativeAI(env_js_1.env.GEMINI_API_KEY);
    }
    catch (e) {
        console.warn('Gemini SDK setup notice:', e);
    }
}
async function generateBiharTravelRecommendation(params) {
