      ...
      >
        <div className={`w-full px-4 sm:px-8 lg:px-12 xl:px-16 2xl:px-20 h-20 flex items-center justify-between ${
          ...
          {user?.role !== 'VENDOR' && (
            <nav className="hidden lg:flex items-center space-x-8 text-xs sub-nav-label tracking-widest justify-self-center">
              ...
              <div className="relative">
                ...
                >
                  <span><LocalizedText text={"EXPLORE"} /></span>
                  <ChevronDown
              ...
              >
                <span><LocalizedText text={"BOOK"} /></span>
              </Link>
              ...
              <Link
                ...
                className="hover:text-brand-gold transition-colors py-2"
              >
                <span><LocalizedText text={"MAPS"} /></span>
              </Link>
              ...
              <Link
                ...
                className="hover:text-brand-gold transition-colors py-2"
              >
                <span><LocalizedText text={"CALENDAR"} /></span>
              </Link>
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center space-x-1 hover:text-brand-gold transition-colors py-2 focus:outline-none"
                >
                  <span><LocalizedText text={"EXPERIENCE"} /></span>
                  <ChevronDown
                    className={`w-3.5 h-3.5 transition-transform duration-300 ${
          ...
          <div className="flex items-center justify-end justify-self-end space-x-2 sm:space-x-3 lg:space-x-4 header-dropdown-container">
            <div className="hidden xl:block"><AppearanceControls /></div>
            ...
            {(!user || user.role === 'TOURIST') && (
              ...
              >
                ...
                <span className="hidden sm:inline tracking-wider font-semibold"><LocalizedText text={" AI CONCIERGE "} /></span>
              </button>
            )}
              ...
              <div className="hidden lg:flex items-center space-x-3">
                  ...
                  {activeDropdown === 'notifications' && (
                    <div className="absolute right-0 mt-3 w-80 sm:w-96 bg-white text-brand-black rounded-xl border border-brand-brown/20 shadow-2xl overflow-hidden z-50 animate-fadeIn">
                      <div className="p-3.5 bg-cream border-b border-brand-brown/15 flex items-center justify-between">
                        <span className="font-serif font-bold text-xs sub-nav-label text-brand-black"><LocalizedText text={"NOTIFICATIONS"} /></span>
                        <span className="text-[10px] text-brand-maroon font-bold">{unreadNotifCount}<LocalizedText text={" UNREAD"} /></span>
                      </div>
                      <div className="max-h-72 overflow-y-auto divide-y divide-brand-brown/10">
                        {notifications.length === 0 ? (
                          <div className="p-6 text-center text-xs text-brand-brown/70 font-serif"><LocalizedText text={"No notifications yet"} /></div>
                        ) : (
                      ...
                      ><LocalizedText text={" VIEW ALL NOTIFICATIONS → "} /></Link>
                    </div>
                  )}
                </div>
                ...
                <div className="relative">
                  ...
                  {activeDropdown === 'messages' && (
                    <div className="absolute right-0 mt-3 w-80 sm:w-96 bg-white text-brand-black rounded-xl border border-brand-brown/20 shadow-2xl overflow-hidden z-50 animate-fadeIn">
                      <div className="p-3.5 bg-cream border-b border-brand-brown/15 flex items-center justify-between">
                        <span className="font-serif font-bold text-xs sub-nav-label text-brand-black"><LocalizedText text={"TOURIST MESSAGES"} /></span>
                        <span className="text-[10px] text-brand-maroon font-bold">{unreadMsgCount}<LocalizedText text={" UNREAD"} /></span>
                      </div>
                      <div className="max-h-72 overflow-y-auto divide-y divide-brand-brown/10">
                        {conversations.length === 0 ? (
                          <div className="p-6 text-center text-xs text-brand-brown/70 font-serif"><LocalizedText text={"No messages yet"} /></div>
                        ) : (
                      ...
                      <Link
                        ...
                        onClick={() => setActiveDropdown(null)}
                        className="block py-2.5 text-center bg-cream text-[11px] sub-nav-label text-brand-maroon font-bold hover:bg-brand-black hover:text-brand-gold transition-colors border-t border-brand-brown/10"
                      ><LocalizedText text={" VIEW ALL MESSAGES → "} /></Link>
                    </div>
                  )}
                </div>
                ...
                >
                  ...
                  <span><LocalizedText text={"REVIEW STOREFRONT"} /></span>
                </Link>
                ...
                >
                  ...
                  <span><LocalizedText text={"VENDOR PORTAL"} /></span>
                </Link>
              </div>
            )}
            ...
            {user?.role === 'ADMIN' && (
              ...
              >
                ...
                <span><LocalizedText text={"ADMIN"} /></span>
              </Link>
            )}
            ...
            {user ? (
                  ...
                  <div className="absolute right-0 mt-3 w-56 bg-white text-brand-black rounded-xl border border-brand-brown/20 shadow-2xl overflow-hidden z-50 animate-fadeIn text-xs">
                    ...
                    <div className="py-1">
                      {user.role === 'TOURIST' ? (
                        <>
                          ...
                          >
                            ...
                            <span><LocalizedText text={"My Profile & Bookings"} /></span>
                          </Link>
                          <Link
                            to="/account/messages"
                            onClick={() => setActiveDropdown(null)}
                          ...
                          >
                            <span className="flex items-center space-x-2">
                              ...
                              <span><LocalizedText text={"My Vendor Messages"} /></span>
                            </span>
                        ...
                        <>
                          ...
                          >
                            <UserCheck className="w-4 h-4 text-brand-gold" />
                            <span><LocalizedText text={"Business Profile"} /></span>
                          </Link>
                        </>
                      )}
                      <Link
                      ...
                      >
                        ...
                        <span><LocalizedText text={"Account Settings"} /></span>
                      </Link>
                    </div>
                    <div className="border-t border-brand-brown/10 pt-1 pb-1">
                      ...
                      >
                        ...
                        <span><LocalizedText text={"SIGN OUT"} /></span>
                      </button>
                    </div>
                  </div>
                )}
              ...
              >
                ...
                <span><LocalizedText text={"SIGN IN"} /></span>
              </Link>
            )}
