      ...
      <nav className="flex flex-col space-y-5 my-6 text-lg sm:text-xl font-serif">
            ...
            <div className="flex flex-col space-y-2">
              <div className="flex items-center justify-between">
                <Link to="/experience" onClick={onClose} className="flex items-center space-x-4 hover:text-brand-gold py-1">
                  ...
                  <span><LocalizedText text={"EXPERIENCE & CUISINE"} /></span>
                </Link>
                <button
              ...
              {experienceOpen && (
                <div className="pl-9 flex flex-col space-y-2 text-base text-cream/80 border-l border-brand-gold/30 ml-2 py-1">
                  <Link to="/experience" onClick={onClose} className="hover:text-brand-gold"><LocalizedText text={" Festivals & Cultural Fairs "} /></Link>
                  <Link to="/experience/cuisine" onClick={onClose} className="hover:text-brand-gold"><LocalizedText text={" Traditional Bihari Cuisine & Taste "} /></Link>
                </div>
              )}
            </div>
        ...
        {user?.role === 'VENDOR' && (
          <div className="flex flex-col space-y-3">
            <span className="text-[10px] sub-nav-label text-brand-gold tracking-widest"><LocalizedText text={"VENDOR MANAGEMENT PORTAL"} /></span>
            ...
            <Link to="/vendor/notifications" onClick={onClose} className="flex items-center justify-between text-base hover:text-brand-gold py-1">
              <span className="flex items-center space-x-3">
                ...
                <span><LocalizedText text={"VENDOR NOTIFICATIONS"} /></span>
              </span>
              <span className="text-xs bg-brand-gold text-brand-black px-2 py-0.5 rounded-full font-bold"><LocalizedText text={"ALERTS"} /></span>
            </Link>
            ...
            <Link to="/vendor/messages" onClick={onClose} className="flex items-center justify-between text-base hover:text-brand-gold py-1">
              <span className="flex items-center space-x-3">
                ...
                <span><LocalizedText text={"TOURIST MESSAGES"} /></span>
              </span>
              <span className="text-xs bg-brand-gold text-brand-black px-2 py-0.5 rounded-full font-bold"><LocalizedText text={"INBOX"} /></span>
            </Link>
            ...
            <Link to="/vendor/storefront-preview" onClick={onClose} className="flex items-center space-x-3 text-base hover:text-brand-gold py-1">
              ...
              <span><LocalizedText text={"REVIEW PUBLIC STOREFRONT"} /></span>
            </Link>
            ...
            <Link to={homeRoute} onClick={onClose} className="flex items-center space-x-3 text-base text-amber-300 hover:text-amber-200 py-1">
              ...
              <span><LocalizedText text={"VENDOR DASHBOARD"} /></span>
            </Link>
          </div>
        )}
