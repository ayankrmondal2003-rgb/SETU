    ...
    <footer className="bg-brand-black text-cream border-t border-cream/15 pt-20 pb-12 px-6 md:px-12">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
        ...
        <div className="md:col-span-4 space-y-6">
          ...
          <div className="pt-2">
            <span className="sub-nav-label text-brand-gold text-xs block mb-2"><LocalizedText text={"OFFICIAL PLATFORM"} /></span>
            <p className="text-xs text-cream/50"><LocalizedText text={"Department of Tourism & Cultural Preservation, Bihar"} /></p>
          </div>
        </div>
        ...
        <div className="md:col-span-3 space-y-4">
          ...
          <ul className="space-y-2.5 text-sm font-serif text-cream/80">
            <li><Link to="/explore/circuits/buddhist-circuit" className="hover:text-brand-gold transition-colors"><LocalizedText text={"Buddhist Heritage Circuit"} /></Link></li>
            <li><Link to="/explore/circuits/eco-circuit" className="hover:text-brand-gold transition-colors"><LocalizedText text={"Eco & Wilderness Circuit"} /></Link></li>
            <li><Link to="/explore/circuits/ramayan-circuit" className="hover:text-brand-gold transition-colors"><LocalizedText text={"Ramayan Spiritual Trail"} /></Link></li>
            <li><Link to="/explore/circuits/sikh-circuit" className="hover:text-brand-gold transition-colors"><LocalizedText text={"Sikh Heritage Circuit"} /></Link></li>
            <li><Link to="/explore/destinations" className="hover:text-brand-gold transition-colors text-xs sub-nav-label text-brand-gold pt-2 block">{t('nav.destinations', 'All Destinations')}<LocalizedText text={" →"} /></Link></li>
          </ul>
        </div>
      ...
      <div className="max-w-7xl mx-auto border-t border-cream/10 pt-8 flex flex-col md:flex-row items-center justify-between text-xs text-cream/50 space-y-4 md:space-y-0">
        <p><LocalizedText text={"© "} />{new Date().getFullYear()} {t('footer.rights', 'Setu Bihar Tourism Platform. All rights reserved.')}</p>
