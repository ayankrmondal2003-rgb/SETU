      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-2 border-b border-brand-brown/15 pb-2">
            ...
            <span className="sub-nav-label text-brand-maroon"><LocalizedText text={"TOUCH / FESTIVALS"} /></span>
          </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-2 border-b border-brand-brown/15 pb-2">
            ...
            <span className="sub-nav-label text-brand-maroon"><LocalizedText text={"SEE / FAIRS"} /></span>
          </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-2 border-b border-brand-brown/15 pb-2">
            ...
            <span className="sub-nav-label text-brand-maroon"><LocalizedText text={"TASTE / CUISINE"} /></span>
          </div>
