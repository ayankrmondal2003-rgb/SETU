  ...
  if (loading) {
    return (
      <div className="pt-32 pb-24 text-center space-y-3 font-serif text-brand-brown">
        ...
        <p><LocalizedText text={"Loading vendor storefront..."} /></p>
      </div>
    );
  }
    ...
    return (
      <div className="pt-32 pb-24 max-w-xl mx-auto px-6 text-center space-y-4 font-sans">
        <div className="bg-cream/90 border border-brand-brown/20 p-8 rounded-xl space-y-3">
          <h2 className="font-serif text-2xl text-brand-black"><LocalizedText text={"Storefront Not Found"} /></h2>
          <p className="text-sm font-serif text-brand-brown">{error || 'The requested vendor profile does not exist or is not public.'}</p>
          <Link to="/" className="inline-block px-5 py-2.5 bg-brand-black text-brand-gold sub-nav-label text-xs tracking-widest rounded"><LocalizedText text={" RETURN TO HOME "} /></Link>
        </div>
      </div>
    );
  }
    ...
    <div className="pt-24 pb-24 font-sans">
      ...
      {isPreview && (
        <div className="bg-brand-black text-brand-gold py-2.5 px-6 text-center text-xs sub-nav-label tracking-widest flex items-center justify-center space-x-2 border-b border-brand-gold/30">
          ...
          <span><LocalizedText text={"STOREFRONT PREVIEW MODE — THIS IS HOW TOURISTS VIEW YOUR PUBLIC BUSINESS PROFILE"} /></span>
        </div>
      )}
        ...
        <div className="bg-white/95 backdrop-blur-md rounded-2xl border border-brand-brown/20 p-6 sm:p-8 shadow-xl flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div className="flex items-center space-x-5">
            ...
            <div className="space-y-1">
              <div className="flex items-center space-x-3 flex-wrap gap-2">
                ...
                <span className="text-[10px] sub-nav-label bg-emerald-100 text-emerald-800 border border-emerald-300 px-2.5 py-0.5 rounded-full font-bold"><LocalizedText text={" VERIFIED LOCAL VENDOR "} /></span>
              </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
            {isPreview ? (
              ...
              ><LocalizedText text={" EDIT VENDOR PROFILE "} /></Link>
            ) : (
              <>
                <button
                  onClick={() => {
                ...
                >
                  ...
                  <span><LocalizedText text={"MESSAGE VENDOR"} /></span>
                </button>
                {storefront.phone && (
                  <a
                  ...
                  >
                    ...
                    <span><LocalizedText text={"CALL HOST"} /></span>
                  </a>
                )}
              </>
            )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="bg-cream/90 p-6 rounded-xl border border-brand-brown/15 shadow-sm space-y-4">
              <h3 className="sub-nav-label text-brand-black font-bold"><LocalizedText text={"ABOUT THE VENDOR"} /></h3>
              ...
              <div className="border-t border-brand-brown/10 pt-4 space-y-2 text-xs font-sans text-brand-brown">
                <div className="flex justify-between">
                  <span className="font-semibold text-brand-black"><LocalizedText text={"Base Location:"} /></span>
                  <span>{storefront.city}<LocalizedText text={", Bihar"} /></span>
                </div>
                <div className="flex justify-between">
                  <span className="font-semibold text-brand-black"><LocalizedText text={"Category:"} /></span>
                  <span>{storefront.businessType}</span>
                </div>
                <div className="flex justify-between">
                  <span className="font-semibold text-brand-black"><LocalizedText text={"Active Experiences:"} /></span>
          ...
          <div className="lg:col-span-8 space-y-6">
            <div className="border-b border-brand-brown/15 pb-4 flex items-center justify-between">
              <h2 className="text-2xl font-serif text-brand-black"><LocalizedText text={"Curated Offerings ("} />{storefront.offerings?.length || 0})</h2>
              <span className="text-xs sub-nav-label text-brand-brown"><LocalizedText text={"DIRECT BOOKING VERIFIED"} /></span>
            </div>
            ...
            {(!storefront.offerings || storefront.offerings.length === 0) ? (
              <div className="bg-white/80 p-8 rounded-xl border border-brand-brown/15 text-center text-brand-brown space-y-2">
                <p className="font-serif"><LocalizedText text={"No active offerings currently published by this vendor."} /></p>
              </div>
            ) : (
                    ...
                    <div className="p-5 space-y-3">
                      ...
                      <div className="flex items-center justify-between pt-3 border-t border-brand-brown/10">
                        ...
                        <span className="text-xs sub-nav-label text-brand-maroon font-semibold flex items-center space-x-1">
                          <span><LocalizedText text={"BOOK NOW"} /></span>
