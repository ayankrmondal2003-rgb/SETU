  ...
  return (
    <div className="pt-28 pb-24 px-4 sm:px-6 md:px-12 max-w-7xl mx-auto space-y-6 font-sans">
      <div className="border-b border-brand-brown/15 pb-4">
        <span className="sub-nav-label text-brand-maroon"><LocalizedText text={"VENDOR PORTAL"} /></span>
        <h1 className="text-3xl font-serif text-brand-black font-bold"><LocalizedText text={"Tourist Messages & Inbox"} /></h1>
      </div>

      {loading ? (
        <div className="py-20 text-center text-brand-brown font-serif"><LocalizedText text={"Loading conversations..."} /></div>
        ...
        <div className="bg-cream/80 p-12 rounded-xl border border-brand-brown/15 text-center space-y-3">
          ...
          <p className="text-sm font-serif text-brand-brown/80"><LocalizedText text={" Inquiries from tourists booking your experiences will appear here. "} /></p>
        </div>
      ) : (
        <div className="bg-white rounded-2xl border border-brand-brown/20 shadow-lg grid grid-cols-1 lg:grid-cols-12 min-h-[550px] overflow-hidden">
          ...
          <div className={`lg:col-span-4 border-r border-brand-brown/15 bg-cream/50 flex flex-col ${
            ...
            <div className="p-4 border-b border-brand-brown/10 font-serif font-bold text-brand-black text-sm sub-nav-label"><LocalizedText text={" CONVERSATIONS ("} />{conversations.length})
            </div>
          ...
          <div className={`lg:col-span-8 flex flex-col ${
            ...
            {activeConvDetails ? (
              ...
              <div className="flex-grow flex items-center justify-center text-center p-8 text-brand-brown font-serif text-sm"><LocalizedText text={" Select a conversation from the left pane to view messages. "} /></div>
            )}
          </div>
        </div>
      )}
