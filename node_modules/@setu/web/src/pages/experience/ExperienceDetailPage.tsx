  ...
  if (loading) {
    return (
      <div className="pt-36 pb-24 max-w-4xl mx-auto px-6 text-center space-y-4">
        ...
        <span className="sub-nav-label text-brand-maroon text-xs block"><LocalizedText text={"LOADING EXPERIENCE DETAILS..."} /></span>
      </div>
    );
  }
  ...
  if (notFound || (!event && !cuisineItem)) {
    return (
      <div className="pt-36 pb-24 max-w-4xl mx-auto px-6 text-center space-y-6">
        ...
        <h2 className="font-serif text-3xl text-brand-black font-bold"><LocalizedText text={"Content Not Found"} /></h2>
        <p className="font-serif text-brand-brown/80 max-w-md mx-auto leading-relaxed text-sm md:text-base"><LocalizedText text={" The requested cultural experience or cuisine item \""} />{slug}<LocalizedText text={"\" could not be located. It may have been updated or moved. "} /></p>
        <Link
          to="/calendar"
        ...
        ><LocalizedText text={" RETURN TO CULTURAL CALENDAR "} /></Link>
      </div>
    );
  }
      ...
      <div className="relative h-[60vh] min-h-[420px] w-full bg-brand-black text-white overflow-hidden">
        ...
        <div className="absolute bottom-10 left-0 right-0 max-w-7xl mx-auto px-6 md:px-12 space-y-3">
          <Link to="/calendar" className="inline-flex items-center space-x-2 text-xs sub-nav-label text-brand-gold hover:text-white mb-2 transition-colors">
            ...
            <span><LocalizedText text={"2026 CULTURAL CALENDAR"} /></span>
          </Link>
          <div className="flex items-center space-x-3">
            ...
            {event?.isLunar && (
              <span className="text-[10px] sub-nav-label bg-amber-900/60 text-amber-200 border border-amber-500/40 px-2 py-0.5 rounded"><LocalizedText text={" 🌕 LUNAR CALENDAR FESTIVAL "} /></span>
            )}
          </div>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 pt-10 space-y-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-white/80 backdrop-blur-md p-5 rounded-xl border border-white/40 shadow-sm space-y-1">
            <div className="flex items-center space-x-2 text-brand-maroon">
              <Calendar className="w-4 h-4 text-brand-gold" />
              <span className="sub-nav-label text-[10px]"><LocalizedText text={isTaste ? 'SPECIALTY TYPE' : 'FESTIVAL DATES'} /></span>
            </div>
          ...
          <div className="bg-white/80 backdrop-blur-md p-5 rounded-xl border border-white/40 shadow-sm space-y-1">
            <div className="flex items-center space-x-2 text-brand-maroon">
              ...
              <span className="sub-nav-label text-[10px]"><LocalizedText text={isTaste ? 'ORIGIN REGION' : 'DURATION'} /></span>
            </div>
            <p className="font-serif text-sm md:text-base font-bold text-brand-black truncate">
          ...
          <div className="bg-white/80 backdrop-blur-md p-5 rounded-xl border border-white/40 shadow-sm space-y-1">
            <div className="flex items-center space-x-2 text-brand-maroon">
              ...
              <span className="sub-nav-label text-[10px]"><LocalizedText text={isTaste ? 'AVAILABILITY' : 'ENTRY & ADMISSION'} /></span>
            </div>
            <p className="font-serif text-sm md:text-base font-bold text-brand-black truncate">
              <LocalizedText text={isTaste ? 'Statewide Eateries & Dhabas' : 'Free Open Entry'} />
            </p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-md p-5 rounded-xl border border-white/40 shadow-sm space-y-1">
            <div className="flex items-center space-x-2 text-brand-maroon">
              ...
              <span className="sub-nav-label text-[10px]"><LocalizedText text={"LOCATION / REACH"} /></span>
            </div>
            <p className="font-serif text-sm md:text-base font-bold text-brand-black truncate">
              ...
              <div className="space-y-8">
                ...
                <div className="bg-white/80 backdrop-blur-md p-8 rounded-xl border border-white/40 space-y-4 shadow-sm">
                  <span className="sub-nav-label text-brand-maroon">
                    <LocalizedText text={isTaste ? 'CULINARY HERITAGE' : 'HERITAGE & TRADITIONS'} />
                  </span>
                  <h3 className="text-2xl font-serif font-bold text-brand-black"><LocalizedText text={"About "} />{displayTitle}</h3>
                ...
                {isFair && event && (event.nearestPolice || event.nearestHospital || (event.nearbyRestaurants && event.nearbyRestaurants.length > 0)) && (
                  <div className="bg-white/80 backdrop-blur-md p-6 rounded-xl border border-white/40 space-y-4 shadow-sm">
                    <div className="flex items-center space-x-2">
                      ...
                      <h4 className="sub-nav-label text-brand-maroon text-xs"><LocalizedText text={"SAFETY & NEARBY FACILITIES"} /></h4>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs font-sans">
                      {event.nearestPolice && (
                        <div className="p-4 bg-red-50/60 rounded-lg border border-red-200/60 space-y-1">
                          <span className="sub-nav-label text-[10px] text-red-800 font-bold block"><LocalizedText text={"NEAREST POLICE / HELP"} /></span>
                      ...
                      {event.nearestHospital && (
                        <div className="p-4 bg-blue-50/60 rounded-lg border border-blue-200/60 space-y-1">
                          <span className="sub-nav-label text-[10px] text-blue-800 font-bold block"><LocalizedText text={"MEDICAL & EMERGENCY CARE"} /></span>
                      ...
                      {event.nearbyRestaurants && event.nearbyRestaurants.length > 0 && (
                        <div className="p-4 bg-amber-50/60 rounded-lg border border-amber-200/60 space-y-1">
                          <span className="sub-nav-label text-[10px] text-amber-800 font-bold block"><LocalizedText text={"RECOMMENDED NEARBY EATERIES"} /></span>
                ...
                {isTaste && cuisineItem && (
                  <div className="bg-white/80 backdrop-blur-md p-6 rounded-xl border border-white/40 space-y-4 shadow-sm">
                    <div className="flex items-center space-x-2">
                      ...
                      <h4 className="sub-nav-label text-brand-maroon text-xs"><LocalizedText text={"MOST POPULAR & AUTHENTIC RESTAURANTS / DHABAS"} /></h4>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-sans">
                      {cuisineItem.restaurants && cuisineItem.restaurants.length > 0 ? (
                        ...
                        <p className="text-xs font-serif text-brand-brown/70"><LocalizedText text={" Served at authentic food stalls and heritage sweet shops across "} />{cuisineItem.district || 'Bihar'}.
                        </p>
                      )}
                    </div>
                  </div>
                ...
                {!isTaste && (
                  <div className="bg-white/80 backdrop-blur-md p-6 rounded-xl border border-white/40 space-y-4 shadow-sm">
                    <h4 className="sub-nav-label text-brand-maroon text-xs"><LocalizedText text={"WHAT TO EXPECT & HIGHLIGHTS"} /></h4>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-sans">
                      <div className="flex items-start space-x-3 p-3.5 bg-white/60 backdrop-blur-sm rounded-lg border border-white/60">
                        ...
                        <div>
                          <strong className="block font-bold text-brand-black"><LocalizedText text={"Ritual Processions & Prayers"} /></strong>
                          <span className="text-brand-brown/80"><LocalizedText text={"Traditional chanting, sacred lamps, and ceremonial offerings at dawn and dusk."} /></span>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3 p-3.5 bg-white/60 backdrop-blur-sm rounded-lg border border-white/60">
                        <Compass className="w-5 h-5 text-brand-gold flex-shrink-0 mt-0.5" />
                        <div>
                          <strong className="block font-bold text-brand-black"><LocalizedText text={"Artisan Fairs & Mithila Crafts"} /></strong>
                          <span className="text-brand-brown/80"><LocalizedText text={"Local vendor stalls featuring handwoven textiles, terracotta, and authentic Bihari cuisine."} /></span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                {!isTaste && (
                  <div className="bg-white/80 backdrop-blur-md p-6 rounded-xl border border-white/40 space-y-4 shadow-sm">
                    <h4 className="sub-nav-label text-brand-maroon text-xs"><LocalizedText text={"EVENT SPECIFICATIONS"} /></h4>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-xs font-sans">
                      <div>
                        <span className="text-brand-brown/70 block text-[10px] sub-nav-label"><LocalizedText text={"DISTRICT"} /></span>
                        <span className="font-bold text-brand-black text-sm">{event?.district || 'Bihar'}</span>
                      </div>
                      <div>
                        <span className="text-brand-brown/70 block text-[10px] sub-nav-label"><LocalizedText text={"CATEGORY"} /></span>
                        <span className="font-bold text-brand-black text-sm">{event?.category || 'Cultural'}</span>
                      </div>
                      <div>
                        <span className="text-brand-brown/70 block text-[10px] sub-nav-label"><LocalizedText text={"SCHEDULE"} /></span>
                        <span className="font-bold text-brand-black text-sm">{datesFormatted}</span>
                      </div>
                      <div>
                        <span className="text-brand-brown/70 block text-[10px] sub-nav-label"><LocalizedText text={"GPS COORDINATES"} /></span>
            ...
            {activeTab === 'gallery' && (
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs text-brand-brown font-sans"><LocalizedText text={"Click image to enlarge"} /></span>
                </div>
            ...
            {isTaste ? (
              <div className="bg-white/80 backdrop-blur-md p-6 rounded-xl border border-white/40 shadow-sm space-y-4">
                <div className="flex items-center space-x-2">
                  ...
                  <h4 className="sub-nav-label text-brand-maroon"><LocalizedText text={"RECOMMENDED EATERIES"} /></h4>
                </div>
                <p className="text-xs font-serif text-brand-black/80"><LocalizedText text={" Top verified traditional outlets serving authentic "} />{cuisineItem?.name}.
                </p>
                ...
                ><LocalizedText text={" EXPLORE CULTURAL CALENDAR "} /></Link>
              </div>
            ) : (
              <div className="bg-white/80 backdrop-blur-md p-6 rounded-xl border border-white/40 shadow-sm space-y-6">
                <h4 className="sub-nav-label text-brand-maroon"><LocalizedText text={"PLAN YOUR VISIT"} /></h4>
                <p className="text-xs font-serif text-brand-black/80"><LocalizedText text={" Experience this event with curated guide services, authentic local cuisine tastings, and private transport. "} /></p>
                <div className="space-y-3">
                  <Link
                    to="/calendar"
                  ...
                  ><LocalizedText text={" VIEW FULL CALENDAR "} /></Link>
                  <Link
                    to="/explore/circuits"
                  ...
                  ><LocalizedText text={" BOOK HERITAGE TOUR "} /></Link>
                </div>
              </div>
            )}
          </div>
        ...
        {event?.nearbyAttractions && event.nearbyAttractions.length > 0 && (
          <div className="pt-12 border-t border-brand-brown/15 space-y-6">
            <div className="space-y-1">
              <span className="sub-nav-label text-brand-maroon"><LocalizedText text={"REGIONAL EXPLORATION"} /></span>
              <h3 className="text-2xl md:text-3xl font-serif text-brand-black"><LocalizedText text={" NEARBY HERITAGE ATTRACTIONS IN "} />{event.district.toUpperCase()}
              </h3>
            </div>
