...
export const OfferingDetailPage: React.FC = () => {
  ...
  if (loading) {
    return <p className="pt-32 pb-24 text-center font-serif text-brand-brown"><LocalizedText text={"Loading offering..."} /></p>;
  }

  if (!offering) {
    return (
      <div className="pt-32 pb-24 text-center space-y-3">
        <h2 className="text-2xl font-serif text-brand-black"><LocalizedText text={"Offering Not Found"} /></h2>
      </div>
    );
  }
      ...
      <div className="lg:col-span-8 space-y-6">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center space-x-5 text-xs font-sans text-brand-brown">
            ...
            <span className="flex items-center space-x-1"><Users className="w-4 h-4" /><span><LocalizedText text={"Up to "} />{offering.maxGuests}<LocalizedText text={" guests"} /></span></span>
          </div>
        ...
        {offering.gallery && offering.gallery.length > 0 && (
          <div className="space-y-3 pt-2">
            <span className="text-[10px] sub-nav-label text-brand-maroon uppercase font-bold"><LocalizedText text={"EXPERIENCE PHOTO GALLERY"} /></span>
        ...
        {offering.vendor && (
          <div className="bg-white/80 backdrop-blur-md p-6 rounded-xl border border-white/40 shadow-sm space-y-2">
            <span className="text-[10px] sub-nav-label text-brand-brown/70 font-bold block"><LocalizedText text={"VERIFIED LOCAL HOST"} /></span>
      ...
      <div className="lg:col-span-4">
        <div className="bg-white p-6 rounded border border-brand-brown/15 shadow-sm space-y-5 lg:sticky lg:top-28">
          <div className="flex items-baseline justify-between">
            ...
            <span className="text-xs font-sans text-brand-brown"><LocalizedText text={"per guest"} /></span>
          </div>

          <div>
            <label className="block text-xs sub-nav-label text-brand-maroon mb-2 flex items-center space-x-1">
              <CalendarDays className="w-3.5 h-3.5" /><span><LocalizedText text={"BOOKING DATE"} /></span>
            </label>
            <input
              type="date"
              value={bookingDate}
          ...
          <div>
            <label className="block text-xs sub-nav-label text-brand-maroon mb-2"><LocalizedText text={"GUESTS"} /></label>
            <input
              type="number"
              min={1}
          ...
          <div className="pt-3 border-t border-brand-brown/10 flex items-center justify-between text-sm font-sans">
            <span className="text-brand-brown"><LocalizedText text={"Total"} /></span>
          ...
          >
            <LocalizedText text={submitting ? 'PROCESSING...' : 'BOOK & PAY WITH RAZORPAY'} />
          </button>
          ...
          {offering.vendor && (
            ...
            >
              ...
              <span><LocalizedText text={"MESSAGE VENDOR INQUIRY"} /></span>
            </button>
          )}
        </div>
      </div>
