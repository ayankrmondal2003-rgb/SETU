  ...
  return (
    <div className="pt-28 pb-24 px-4 sm:px-6 md:px-12 max-w-7xl mx-auto space-y-8 font-sans">
      <div className="space-y-2">
        <span className="text-xs sub-nav-label text-brand-maroon"><LocalizedText text={"GUIDED TOURS & EXPERIENCES"} /></span>
        <h1 className="text-3xl sm:text-4xl font-serif text-brand-black"><LocalizedText text={"Book Bihar Tourism Offerings"} /></h1>
        <p className="text-sm font-serif text-brand-brown/80"><LocalizedText text={"Curated experiences from verified local vendors."} /></p>
      </div>
      ...
      {loading ? (
        <div className="py-20 text-center space-y-3">
          ...
          <p className="font-serif text-brand-brown text-sm"><LocalizedText text={"Loading bookable offerings..."} /></p>
        </div>
      ) : filteredOfferings.length === 0 ? (
        <div className="bg-white/80 backdrop-blur-md border border-brand-brown/15 rounded-xl p-12 text-center space-y-4">
          <p className="font-serif text-lg text-brand-black"><LocalizedText text={" No offerings currently listed under \""} />{selectedCategory}".
          </p>
          <button
            type="button"
          ...
          ><LocalizedText text={" SHOW ALL OFFERINGS "} /></button>
        </div>
      ) : (
